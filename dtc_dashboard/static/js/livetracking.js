...
function congestionvalue(congestionlevel) {
...
function layerbindpopup(feature, layer) {
    layer.bindPopup("Bus Number: " + feature.properties.vehicle_id.toString() +
        ...
        "<br>" + "Congestion: " + congestionvalue(feature.properties.congestion)
