...
urlpatterns = [
    ...
    url(r'^updatestart/$',playBackView.updatestart,name="update-start"),
    url(r'^updateend/$',playBackView.updateend,name="update-end"),
    url(r'^updatevehicle/$',playBackView.updatevehicle,name="update-vehicle"),
    url(r'^vehiclesonroute/$',playBackView.vehiclesonroute,name="get-vehicles-on-route"),
    ...
    url(r'^filtered_routes/$',playBackView.particular_buses_multiple,name="filtered-routes"),
